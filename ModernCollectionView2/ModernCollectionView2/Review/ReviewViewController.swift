...
final class ReviewViewController: UIViewController {
    ...
    private func setDataSource() {
        ...
        var dataSourceSnapshot = NSDiffableDataSourceSnapshot<Section,Item>() // DataSourceSnapshot
    ...
    private func bindViewModel() {
        ...
        output.reviewResult.map { result -> [ReviewModel] in
            ...
            var sectionSnapshot = NSDiffableDataSourceSectionSnapshot<Item>() // SectionSnapshot
